    ...
    <div class="container mt-3">
        <form action="addboletos.php" method="post" class="p-3">
            <div class="row mb-3">
                <div class="col-md-6 form-group">
                    ...
                    <input type="text" name="tipoboleto" class="form-control border-primary rounded-3" required>
                </div>
                <div class="col-md-6 form-group">
                    <label for="precioboleto">Precio</label>
                    <input type="text" name="precioboleto" class="form-control border-primary rounded-3" required>
                </div>
            </div>
            <div class="row mb-3">
        ...
        <?php
            if(isset($_POST["tipoboleto"])) {
                ...
                echo '<div class="alert alert-info" role="alert">Boleto agregado correctamente.</div>';
                }
        ?>
    </div>
</body>
