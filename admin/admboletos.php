...
<body>
    ...
    <div class="container-fluid w-100">
        <table class="table table-bordered text-center">
            ...
            <tr> 
                <td class="align-middle"><?php echo $r->__get('idboleto'); ?></td>
                <td class="align-middle"><?php echo $r->__get('tipoboleto'); ?></td>
                <td class="align-middle"><?php echo $r->__get('descripcionboleto'); ?></td>
                <td class="align-middle"><?php echo $r->__get('precioboleto'); ?></td>
                <td class="align-middle">
                    <div class="d-flex justify-content-around align-items-stretch">
                        <form action="editboletos.php" method="post">
                            <input type="hidden" name="codigoboleto" id="codigoboleto" value="<?php echo $r->__get('idboleto'); ?>">
