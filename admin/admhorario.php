...
<body>
        ...
        <div class="container-fluid">
            <ul class="nav nav-underline me-auto mb-2 mb-lg-0 ">
                <form action="searchcliente.php" method="post">
                    <input class="border border-primary rounded p-1" type="text" name="dnicliente" placeholder="Buscar horario" maxlength="8" minlength="7" pattern="[0-9]{8}">
    ...
    <div class="container-fluid w-100">
        <table class="table table-bordered text-center">
            ...
            ?>
            <tr> 
                <td class="align-middle"><?php echo $idhorario; ?></td>
                <td class="align-middle"><?php echo $turno ?></td>
                <td class="align-middle">
                    <div class="d-flex justify-content-around align-items-stretch">
                        <form action="edithorario.php" method="post">
                            <input type="hidden" name="codigohorario" id="codigohorario" value="<?php echo $idhorario; ?>">
