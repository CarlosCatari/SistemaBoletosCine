...
<?php
    ...
    <div class="container-fluid w-100">
        <table class="table table-bordered text-center">
            ...
            <tr> 
                <td class="align-middle"><?php echo $r->__get('idpelicula'); ?></td>
                <td class="align-middle"><?php echo $r->__get('nombrepelicula'); ?></td>
                <td class="align-middle"><?php echo $r->__get('sinopsis'); ?></td>
                <td class="align-middle"><?php echo $r->__get('director'); ?></td>
                <td class="align-middle"><?php echo $r->__get('genero'); ?></td>
                <td class="align-middle"><?php echo $r->__get('idioma'); ?></td>
                <td class="align-middle"><?php echo $r->__get('fechaestreno'); ?></td>
                <td class="align-middle"><?php echo $r->__get('duracion'); ?></td>
                <td class="align-middle"><?php echo $r->__get('imagen'); ?></td>
                <td class="align-middle">
                    <div class="d-flex justify-content-around align-items-stretch">
                        <form action="editpelicula.php" method="post">
                            <input type="hidden" name="codigopelicula" id="codigopelicula" value="<?php echo $r->__get('idpelicula'); ?>">
