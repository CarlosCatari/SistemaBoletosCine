...
<body>
    <nav class="navbar navbar-expand-lg bg-primary">    
        <div>
            <a class="navbar-brand fw-bold" href="admpclientes.php">
        ...
        <form action="admclientes.php" method="post" class="p-3">
            <div class="row mb-3">
                <div class="col-md-6 form-group">
                    ...
                    <input type="text" name="codcliente" class="form-control border-primary rounded-3" value="<?php echo $idcliente; ?>" required>
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-md-6 form-group">
