        ...
        <form action="admhorario.php" method="post" class="p-3">
            <div class="row mb-3">
                <div class="col-md-6 form-group">
                    ...
                    <input type="text" name="cdhorario" class="form-control border-primary rounded-3" value="<?php echo $idhorario; ?>" required>
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-md-6 form-group">
                    <label for="turnohorario">Turno</label>
                    <input type="text" name="turnohorario" class="form-control border-primary rounded-3" value="<?php echo $turno; ?>" required>
                </div>
            </div>
