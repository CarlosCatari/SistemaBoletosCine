...
<body class="justify-content-center align-items-center vh-100">
        ...
        <div class="bg-white p-5 rounded-5 text-secondary" style="width:50rem">
            ...
            <div class="d-flex justify-content-evenly align-items-center mb-3">
                <div style="width:20rem">
                    ...
                    <input class="form-control" value="<?php echo $user; ?>" name="dniuser" type="text" id="document" placeholder="Nº de documento" pattern="[0-9]{8}"  required>
                </div>
                <div style="width:20rem">
    ...
    <?php
        if(isset($_POST["dniuser"])) {
            ...
            echo '<div class="alert alert-info" role="alert">Datos modificados correctamente.!</div>';
        }
    ?>
</body>
